          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-5 text-left">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-[44px] font-extrabold text-ink-primary tracking-tight leading-[1.15]">
                ...
                <span className="text-primary">Sebelum Menjadi Terlambat.</span>
              </h1>

              {/* Subtext */}
              <p className="text-sm sm:text-base text-ink-secondary leading-relaxed max-w-xl">
                RUANG ISU membantu memantau dinamika isu sosial-politik dari tingkat Purwakarta hingga nasional, memverifikasi berbagai sumber data, dan menggunakan AI untuk menyusun bahan kajian advokasi yang terarah.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                <Link
                  href="/isu"
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-ink-primary hover:bg-black text-white text-xs sm:text-sm font-semibold rounded-btn transition-colors"
                >
                ...
                <Link
                  href="/ai-analyst"
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-surface hover:bg-muted text-ink-primary text-xs sm:text-sm font-semibold rounded-btn border border-border transition-colors"
                >
              ...
              {/* Territory context */}
              <div className="pt-4 border-t border-border flex items-center gap-2 text-xs text-ink-tertiary">
                <span className="text-ink-secondary font-medium">Fokus Pemantauan:</span>
                <span>1. Purwakarta (17 Kecamatan)</span>
                <span>·</span>
            ...
            <div className="lg:col-span-5">
              <div className="bg-surface rounded-card border border-border p-6 shadow-subtle space-y-4">
                ...
                <div className="flex items-center justify-between text-xs text-ink-tertiary pt-1">
                  <span>{snapshotIssue.sources_count} rujukan sumber</span>
                  <span>Diperbarui 24 Agu 2026</span>
                </div>
